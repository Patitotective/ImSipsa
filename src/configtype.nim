...
type Config* = object
  ...
  authors* = [(name: "Patitotective", url: "https://github.com/Patitotective")]
  categories* = ["Utility"]
  ...
  fonts* = [
    font("assets/ProggyVector Regular.ttf", 16f)
      # Other options are Roboto-Regular.ttf, Cousine-Regular.ttf or Karla-Regular.ttf
